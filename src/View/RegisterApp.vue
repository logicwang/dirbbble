      ...
      <div class="padding self-adaption">
          ...
          <div class="flex">
            ...
            <div class="neirong">
              <div class="center-third">
                ...
                <li class="name">
                  <router-link to="/list/Identity" class="right flexstart paddingzero">
                    <svg t="1659010944159" class="icon-Identity" viewBox="0 0 1024 1024" version="1.1"
                ...
                <li class="name">
                  <router-link to="/list/SecureNote" class="items Note flexstart paddingzero" style="padding: 0px;">
                    <svg t="1659010990378" class="icon-note" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <h1 class="items" style="padding-left:11px;">Secure Note</h1>
                  </router-link>
                </li>
              </div>
            </div>
        ...
        <div class="flex folders">
          ...
          <div class="neirong">
            <div class="center-third">
              <li class="name">
                <router-link to="/list/Work" class="items flexstart" style="padding: 0;">
              ...
              <li class="name">
                <router-link to="/list/Social" class="flexstart" style="border-radius: 6px;">
                  <svg t="1659012537214" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6902" width="15" height="15">
                    <path
                      d="M948.053333 341.333333V290.133333c0-28.16-23.04-51.2-51.2-51.2h-306.346666v-34.133333c0-28.16-23.04-51.2-51.2-51.2h-392.533334c-28.16 0-51.2 23.04-51.2 51.2v136.533333h852.48zM95.573333 409.6v409.6c0 28.16 23.04 51.2 51.2 51.2h750.08c28.16 0 51.2-23.04 51.2-51.2V409.6H95.573333z"
              ...
              <li class="name">
                <router-link to="/list/Personal" class="items right flexstart" style="padding: 0;">
                  <svg t="1659012537214" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6902" width="15" height="15">
                    <path
                      d="M948.053333 341.333333V290.133333c0-28.16-23.04-51.2-51.2-51.2h-306.346666v-34.133333c0-28.16-23.04-51.2-51.2-51.2h-392.533334c-28.16 0-51.2 23.04-51.2 51.2v136.533333h852.48zM95.573333 409.6v409.6c0 28.16 23.04 51.2 51.2 51.2h750.08c28.16 0 51.2-23.04 51.2-51.2V409.6H95.573333z"
                  ...
                  <h1 class="items" style="padding-left:4px;">Personal</h1>
                </router-link>
              </li>
            </div>
          </div>
