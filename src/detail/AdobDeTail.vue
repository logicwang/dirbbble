        ...
        <div class="max-width">
            <div class="header-right borderbottom">
                <div class="display padding">
                    ...
                    <button>
                        <div class="delete">
                            <svg t="1660048661978" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="1968" width="20" height="20">
                                <path
